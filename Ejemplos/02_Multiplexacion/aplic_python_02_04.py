#!/usr/bin/env python
# Multiplexando un servidor web básico usando select.epoll
...
Hola desde un servidor Epoll!"""


class EpollServer(object):
    """ Un servidor usando Epoll"""
    ...
    def run(self):
        """Ejecuta las operaciones del servidor epoll"""
        try:
